var Circle = function(p,startX,startY){
  this.processing = p;
  this.attributes = {
    radius: 1.0,
    currentX: startX,
...
Circle.prototype.moveTo = function(newX, newY){
  this.attributes.currentX = newX;
  this.attributes.currentY = newY;
}

Circle.prototype.resize = function(newRadius){
  this.attributes.radius = newRadius;
}

Circle.prototype.isWithinInfluenceOf = function(cursor){
...
Circle.prototype.decay = function(cursor){
